...
**PM-Skills** is an open-source collection of 31 product management skills that teach AI assistants how to create professional PM documents. The current repo includes 25 phase skills, 1 foundation skill, and 5 utility skills. Think of it as a playbook that transforms generic AI responses into polished, consistent PM artifacts.
...
- **31 skills in `skills/`** covering the PM lifecycle (25 phase skills + 1 foundation skill + 5 utility skills)
...
The repo currently ships 38 command markdown files: 31 skill commands plus 7 workflow commands.
...
| Utility | `/pm-skill-builder`, `/pm-skill-validate`, `/pm-skill-iterate`, `/mermaid-diagrams`, `/slideshow-creator` |
| Foundation | `/persona` |
...
- Lists all 31 registered skills with paths and descriptions
- Provides workflows
